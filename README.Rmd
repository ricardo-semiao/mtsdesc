...
[![CRAN status](https://www.r-pkg.org/badges/version/varr)](https://CRAN.R-project.org/package=varr)
...
The varr R package is being developed to provide general utility functions for projects involving Vector Auto-Regressive models, with specifically the [vars package](https://cran.r-project.org/web/packages/vars/index.html).
...
You can install the development version of varr from [GitHub](https://github.com/) with:
